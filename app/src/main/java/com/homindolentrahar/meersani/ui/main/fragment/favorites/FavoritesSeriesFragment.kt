 ...
 */
class FavoritesSeriesFragment : DaggerFragment() {

    @Inject
    lateinit var providerFactory: ViewModelProviderFactory

    private lateinit var viewModel: FavoritesSeriesViewModel
    private lateinit var adapter: FavoritesItemAdapter
    private val TAG = FavoritesSeriesFragment::class.java.simpleName
...
//        ViewModel setup
        viewModel =
            ViewModelProviders.of(this, providerFactory).get(FavoritesSeriesViewModel::class.java)
//        RecyclerView setup
        setupRecyclerView()
//        Observing data
        observingData()
