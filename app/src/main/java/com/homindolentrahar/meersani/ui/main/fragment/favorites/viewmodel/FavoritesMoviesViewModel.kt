...
class FavoritesMoviesViewModel @Inject constructor(private val repository: DataRepository) :
    ViewModel() {
    fun getFavoritesMovies(): Flowable<List<Favorites>> {
        return repository.getFavoritesByType(Constants.FAVORITES_MOVIES)
    }
}